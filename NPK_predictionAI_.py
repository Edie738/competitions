  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Edie738/competitions/blob/master/NPK_predictionAI_.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "source": [
        "ata = pd.read_csv('https://raw.githubusercontent.com/Edie738/ProjectStuff/master/Soil-Analysis-and-Yield-Prediction-master/Soil-Analysis-and-Yield-Prediction-master/TestingAndTrainingDataSet.csv?token=AM5B2MY7SOCVJ7OHECTLEOK5PO3FS')"
      ],
      "execution_count": 0,
      "outputs": []
    },
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "f2bf6427-1174-485c-ffa9-7d0c0a926b44"
      },
      "source": [
      ...
      "outputs": [
        {
          ...
          "data": {
            "text/plain": [
              "<matplotlib.axes._subplots.AxesSubplot at 0x7fdd320e68d0>"
            ]
          },
          "metadata": {
            "tags": []
    ...
    },
    {
      ...
      "source": [
        ...
        "y1 = Data.drop(['name', 'mg kg','Cu','m..Fe','Aval P','Aval K','mg..Mn','S','pH','EC', '%O.C'], axis = 1)\n",
        "y2 = Data.drop(['name', 'mg kg','Cu','m..Fe','Aval N','Aval K','mg..Mn','S','pH','EC', '%O.C'], axis = 1)\n",
        "y3 = Data.drop(['name', 'mg kg','Cu','m..Fe','Aval N','Aval P','mg..Mn','S','pH','EC', '%O.C'], axis = 1)"
      ],
      "execution_count": 0,
      "outputs": []
    },
    ...
    },
    {
      ...
      "source": [
        ...
        "y1 = tf.keras.utils.normalize(y1)\n",
        "y2 = tf.keras.utils.normalize(y2)\n",
        "y3 = tf.keras.utils.normalize(y3)"
      ],
      "execution_count": 0,
      "outputs": []
    },
    ...
    },
    {
      ...
      "source": [
        ...
        "modelB1 = DecisionTreeRegressor()\n",
        "modelB2 = DecisionTreeRegressor()\n",
        "modelB3 = DecisionTreeRegressor()\n",
        "modelC1 = KNeighborsRegressor()\n",
        "modelC2 = KNeighborsRegressor()\n",
        "modelC3 = KNeighborsRegressor()"
      ],
      "execution_count": 0,
      "outputs": []
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "fa437fbf-6f31-494f-835e-af191df5a7b4"
      },
      "source": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "ecc6a0fe-5427-40ad-8d62-3c38be8506c2"
      },
      "source": [
        "modelB1.fit(X_train, y1_train)\n",
        "modelB2.fit(X_train, y2_train)\n",
        "modelB3.fit(X_train, y3_train)"
      ],
      "execution_count": 138,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "7ae3bd9a-c37a-4fab-9978-9e490835e2ff"
      },
      "source": [
        "modelC1.fit(X_train, y1_train)\n",
        "modelC2.fit(X_train, y2_train)\n",
        "modelC3.fit(X_train, y3_train)"
      ],
      "execution_count": 139,
      "outputs": [
        {
    ...
    },
    {
      ...
      "source": [
        ...
        "D1_pred = modelB1.predict(X_test)\n",
        "D2_pred = modelB2.predict(X_test)\n",
        "D3_pred = modelB3.predict(X_test)\n",
        "K1_pred = modelC1.predict(X_test)\n",
        "K2_pred = modelC2.predict(X_test)\n",
        "K3_pred = modelC3.predict(X_test)"
      ],
      "execution_count": 0,
      "outputs": []
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "c7dcfd1c-befb-4817-be0e-4ccddea91921"
      },
      "source": [
        "modelA1.score(X_test, y1_test)"
      ],
      "execution_count": 141,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "2956e4ce-3693-4daa-945f-4a67a5511a7f"
      },
      "source": [
        "modelB1.score(X_test, y1_test)"
      ],
      "execution_count": 144,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "8e6743d1-5a46-4887-d52a-5d1f66c58f5c"
      },
      "source": [
        "modelC1.score(X_test, y1_test)"
      ],
      "execution_count": 143,
      "outputs": [
        {
